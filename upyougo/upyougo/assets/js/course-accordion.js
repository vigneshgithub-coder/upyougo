! function (t) {
    ...
    "object" != typeof topylo && (window.topylo = {}), window.topyloCore = {}, topyloCore.shortcodes = {}, topyloCore.listShortcodesScripts = {
        ...
        topyloJustifiedCBSE: topylo.topyloJustifiedCBSE,
...
(function (c) {
    ...
    var e = {
        ...
        initItem: function (e) {
            var o = e.find(".h8_course-m-tab"),
                t = e.find(".h8_course-content-3"),
                n = (e.find(".topylo-e-content-inner"), e.find(".h8_course-m-tab-wrapper")),
                i = o.innerWidth(),
                r = e.find(".h8_course-m-title-vertical").innerHeight(),
